...
int generateVertexArray(float *vertices, float *textureCoordinates, float *normalVectors, unsigned int *indices, unsigned int vertexCount, unsigned int triangleCount)
{
